    ...
    <div className="bg-white text-black">
      <section className="max-w-7xl mx-auto px-4 py-10 sm:px-6 lg:px-8 lg:py-6">
        ...
        <p className="my-5 text-xs">
          ...
          within this document. <br /> • Please note that some provisions in
          these Terms may only apply to certain categories of Users. In
          particular, certain provisions may only apply to Consumers or to those
          Users that do not qualify as Consumers. Such limitations are always
          explicitly mentioned within each affected clause. In the absence of
          any such mention, clauses apply to all Users. <br /> • This Website
          uses automatic renewal for subscriptions. Information about the (a)
          renewal period, (b) termination details and (c) termination notice can
          be found in the relevant section of these Terms
        </p>
        <hr className="my-5" />
        {/* 2nd section */}
